...
rd_uk = read.csv('/Users/maaymadar/Downloads/Faces_analysis/UK2_rd.csv')
ratings_uk = read.csv('/Users/maaymadar/Downloads/Faces_analysis/UK2_ratings.csv')
...
sink("/Users/maaymadar/Downloads/Faces_analysis/results-all.txt")
